...
preds <- unlist(predict(wf_fit, new_data = tst, type = "prob")[, 2])
...
write_csv(sub, here::here("aug_22_tabular/submission/baseline_logreg.csv"))
#so this just predicts the same value for everything -- likely because the penalty in the lasso is too high.